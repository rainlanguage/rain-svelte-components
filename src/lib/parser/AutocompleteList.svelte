<script lang="ts">
	...
	$: text = parentElement.previousElementSibling.innerText;
	...
	$: showAbove =
		resultsBoxHeight > window.innerHeight - opRect.bottom ||
		popupHeight > window.innerHeight - opRect.bottom;
	...
	<div bind:this={resultsBox} class="bg-gray-800 border border-gray-600">
		{#each results as result, i}
			...
			<div
				...
				class:inactive={!activeRes}
				class:active={activeRes}
