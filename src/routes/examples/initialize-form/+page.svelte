<script lang="ts">
	...
	const deployers: typeof _deployers = [];

	for (let i = 0; i < 10; i++) {
		deployers.push(..._deployers);
	}
...
<div class="flex flex-col gap-y-4 dark:text-gray-100">
	<PageHeading>Initialize Form</PageHeading>

	<div class="max-w-prose flex flex-col gap-y-4">
		<div>
			This component takes an ABI and a contract meta, and produces a form for the required inputs
			and expressions to generate his configuration for initialization. This component only take in
	...
	<ExampleHeading id="separated">Showing expressions and config: Sale</ExampleHeading>
	<Example>
		<ExampleComponent>
			<div class="grid grid-cols-3">
				<div class="col-span-2">
